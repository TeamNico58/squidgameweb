...
<body data-theme="dark">
    ...
    <div id="video-container">
        ...
        <div id="season2" class="container">
            ...
            <div class="video"><video class="plyr" id="video14" data-episode="14" controls><source src="https://www.dropbox.com/scl/fi/c59mw7pyalmnb2ay3cxfv/video14.mp4?rlkey=7rxyjx4u9ifcbnhaoukv5rcwn&st=6k5b5ux9&raw=1" type="video/mp4"></video><h3>Episode 5</h3></div>
    ...
    <footer>
        <p>Built with ❤️ by <a href="https://example.com" target="_blank">Nico</a></p>
    </footer>
    ...
    <script>
        ...
        function startPing() {
            ...
            const serverUrl = '/ping'; // Replace with a valid endpoint

            async function calculatePing() {
                try {
                    const startTime = performance.now();
                    await fetch(serverUrl, { method: 'HEAD', cache: 'no-store' });
                    const endTime = performance.now();
                    const ping = Math.round(endTime - startTime);
                    pingDisplay.textContent = `Ping: ${ping} ms`;
                } catch (error) {
                    pingDisplay.textContent = 'Ping: Unavaiable on School Version';
                }
            }

            // Update ping every 3 seconds
            setInterval(calculatePing, 750);
            calculatePing(); // Initial ping calculation
        }
    </script>
</body>
</html>
